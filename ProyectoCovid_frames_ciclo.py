...
def graficar_temperatura():
    canvas_temperaturas.delete("all")
    temperaturas = [35,35.5,36,37,35.5,38,38.6,36.4,37.4,36.5]
    registros = 10
    leidos = 1
    i=0
    while (leidos <= 10):
        canvas_temperaturas.create_rectangle(20 * leidos, 80 - (80 - (39 - temperaturas[i]) * 20), 20 * leidos +15, 80, fill="blue")
        leidos = leidos + 1
        i+=1

# El ciclo servirá para graficar los valores de temperatura que el usuario vaya agregando
# Por el momento usé una lista para ejemplificar el funcionamiento de la gráfica, pero más adelante se usaran los datos ingresados que serán exportados a un archivo externo
...
#   Ocupo la variable leidos para indicar cauntos registros llevo e ir sumandolos a mi posición inicial
